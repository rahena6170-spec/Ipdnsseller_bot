...
def callback_inline(call):
    ...
    # 1. Gmail Create IP (Oxylabs Corporate)
    ...
    # 2. Social Create IP Category (WhatsApp & Instagram)
    elif call.data == 'cat_social':
        markup = types.InlineKeyboardMarkup(row_width=1)
        markup.add(
            types.InlineKeyboardButton("🔹 9Proxy (1 GB - $1)", callback_data='pkg_9Proxy 5GB ($1)'),
    ...
    # 3. Premium DNS
        ...
        markup.add(
            ...
            types.InlineKeyboardButton("Private DNS 1 Year  - $10", callback_data='pkg_DNS 1 Year ($10)'),
            types.InlineKeyboardButton("🔙 Back to Main Menu", callback_data='main_menu')
        )
    ...
    # Payment info after package selection
